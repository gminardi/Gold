...
<table style="width: 400px; border: 1px solid #bbb">
    ...
    <tr>
        <td align="right">
            <div>
                <br />
                <button class="myOKButton" value="Visualizza Foglio Presenza" onclick="valida()">Visualizza
                    Foglio Presenza</button>
            </div>
        </td>
    </tr>
...
<strong>N.Contratto e Nominativo Lavoratore</strong>
<table>
