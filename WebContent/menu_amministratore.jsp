...
<table border="0" cellspacing="1" cellpadding="1">
    ...
    <tbody>
        <tr>
            ...
            <td><form action="search">
                    <input class="myMenuButton" type="submit" value="Stato Lavorazione Fogli">
                </form></td>
            <td><form action="searchprocess">
                    <input class="myMenuButton" type="submit" value="Fogli Presenza">
                </form></td>
            <!--pulsanti visibili solo all'operatore acli *****************************************************-->

            <td><form action="anagraficadatorilavoro">
                    <input class="myMenuButton" type="submit" value="Anagrafica Utenti Gold">
                </form></td>
            ...
            <td><form action="fogliriepilogativi" >
                    <input class="myMenuButton" type="submit" value="Fogli Riepilogativi">
                </form></td>
        </div
    </s:if>
    <s:else>
        <td><form action="search">
                <input class="myMenuButton" type="submit" value="Lista Lavoratori">
            </form></td>
        <td><form action="searchprocess">
                <input class="myMenuButton" type="submit" value="Fogli Presenza">
            </form></td>
    ...
    <td><form action="loginprocess">
            ...
            <input class="myLogoutButton" type="submit" name="logoutButton" value="Logout">
        </form></td>
